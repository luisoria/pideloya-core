    ...
    try {
        ...
        return (
            <div className="p-8 text-center">
                <h1 className="text-2xl font-bold text-red-600 mb-4">Error de Renderizado (DEBUG)</h1>
                <pre className="bg-gray-100 p-4 rounded text-left overflow-auto max-w-full">
                    {e.message}\n{e.stack}
                </pre>
                <p className="mt-4 text-gray-500 text-sm">Por favor, reporta este error al equipo técnico.</p>
            </div>
        )
    }
}
